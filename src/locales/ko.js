...
export default {
  ...
  // Date Format
  monthYearFormat: "{month}월 {year}년",
  ...
  translating: "번역 중",
  processing: "처리 중",
  recipientSearchPlaceholder: "수신자 이름, 부서, 직책 등으로 검색",
  searching: "검색 중",
  noDepartment: "부서 없음",
  noPosition: "직책 없음",
  noSearchResults: "검색 결과가 없습니다.",
  selected: "선택됨",
  generalQuestionProcessing: "일반 질문으로 분류되어 Gemini에게 직접 전송합니다.",
  intentClassificationExpert: "자동차 업계 관리 시스템의 의도 분류 전문가",
  intentAnalysisGuidance: "사용자의 질문을 분석하여 가장 적합한 업무 의도를 분류하고, 관련 정보를 추출해주세요.",
  userMessage: "사용자 메시지",
  possibleIntents: "가능한 업무 의도 목록",
  analysisGuidelines: "분석 지침",
  analysisGuideline1: "사용자 메시지의 의미를 정확히 파악하여 가장 적합한 의도를 선택하세요.",
  analysisGuideline2: "자동차 업계 관련 용어를 이해하고 매칭하세요 (예: 딜러명, 차량 모델, 세그먼트 등).",
  analysisGuideline3: "다음 엔티티들을 추출하세요:",
  entityDealer: "딜러명 (예: \"Hyosung The Class\", \"한성자동차\", \"효성더클래스\")",
  entityMonth: "월 (숫자, 예: 7, 8)",
  entityYear: "년도 (숫자, 예: 2025)",
  entitySegment: "차량 세그먼트 (예: \"Sedan\", \"SUV\", \"세단\")",
  entityModel: "차량 모델명 (예: \"E-Class\", \"GLC\")",
  analysisGuideline4: "영어와 한국어 모두 지원하세요.",
  analysisGuideline5: "만약 사용자의 질문이 자동차 업계 관리 시스템의 업무와 관련이 없는 일반적인 질문(예: 차량 유지보수, 기술적 조언, 일반적인 정보 등)이라면 \"GENERAL_QUESTION\"으로 분류하세요.",
  jsonResponseFormat: "JSON 형식으로만 응답하세요:",
  noMatchingIntent: "적합한 의도가 없으면",
  generalQuestionCase: "일반 질문인 경우",
  example1: "예시:",
  ...
  automotiveExpert: "당신은 자동차 전문가입니다. 사용자의 질문에 대해 정확하고 도움이 되는 답변을 제공해주세요.",
  userQuestion: "사용자 질문",
  responseGuidelines: "답변 시 다음 사항을 고려해주세요",
  responseGuideline1: "정확하고 신뢰할 수 있는 정보 제공",
  responseGuideline2: "자동차 관련 전문 지식 활용",
  responseGuideline3: "안전하고 실용적인 조언 제공",
  responseGuideline4: "필요시 단계별 설명 제공",
  responseGuideline5: "마크다운 형식으로 구조화된 답변 제공 (제목, 목록, 강조 등 활용)",
  responseGuideline6: "한국어로 답변해주세요",

  detectAndRespondInSameLanguage: "사용자가 질문한 언어를 감지하여 같은 언어로 답변해주세요.",
  generalQuestionError: "죄송합니다. 질문에 대한 답변을 생성하는 중 오류가 발생했습니다. 다시 시도해주세요.",
  response: "답변",
  translateToKorean: "다음 텍스트를 자연스러운 한국어로 번역해주세요.",
  translateToGerman: "다음 텍스트를 자연스러운 독일어로 번역해주세요.",
  translationGuidelines: "번역 시 다음 사항을 고려해주세요",
  translationGuideline1: "자동차 업계 전문 용어는 적절한 한국어로 번역",
  translationGuideline2: "비즈니스 이메일 톤 유지",
  translationGuideline3: "자연스러운 한국어 표현 사용",
  translationGuideline4: "원문의 의미를 정확히 전달",
  textToTranslate: "번역할 텍스트",
  translationResult: "번역 결과만 한국어로 출력해주세요.",
